...
const RANDOM_RECONNECT_MIN_MS = Math.max(5 * 60 * 1000, Number(process.env.RANDOM_RECONNECT_MIN_MS || 15 * 60 * 1000))
const RANDOM_RECONNECT_MAX_MS = Math.max(RANDOM_RECONNECT_MIN_MS, Number(process.env.RANDOM_RECONNECT_MAX_MS || 30 * 60 * 1000))
